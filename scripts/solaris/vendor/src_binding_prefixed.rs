...
pub type cppgc_GarbageCollected_IsGarbageCollectedTypeMarker = ::std::os::raw::c_void;
...
const _: () = {
    ["Size of cppgc_NameProvider"][::std::mem::size_of::<cppgc_NameProvider>() - 8usize];
    ["Alignment of cppgc_NameProvider"][::std::mem::align_of::<cppgc_NameProvider>() - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of v8_CTypeInfo"][::std::mem::align_of::<v8_CTypeInfo>() - 1usize];
    ["Offset of field: v8_CTypeInfo::type_"][::std::mem::offset_of!(v8_CTypeInfo, type_) - 0usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of v8_FastOneByteString"][::std::mem::size_of::<v8_FastOneByteString>() - 16usize];
    ["Alignment of v8_FastOneByteString"][::std::mem::align_of::<v8_FastOneByteString>() - 8usize];
...
pub const v8_CFunctionInfo_Int64Representation_kNumber: v8_CFunctionInfo_Int64Representation = 0;
pub const v8_CFunctionInfo_Int64Representation_kBigInt: v8_CFunctionInfo_Int64Representation = 1;
pub type v8_CFunctionInfo_Int64Representation = u8;
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of v8_CFunctionInfo"][::std::mem::size_of::<v8_CFunctionInfo>() - 16usize];
    ["Alignment of v8_CFunctionInfo"][::std::mem::align_of::<v8_CFunctionInfo>() - 8usize];
...
impl v8_CFunctionInfo {
    #[inline]
    pub unsafe fn ArgumentInfo(&self, index: ::std::os::raw::c_uint) -> *const v8_CTypeInfo {
...
pub const v8_CFunction_OverloadResolution_kImpossible: v8_CFunction_OverloadResolution = 0;
pub const v8_CFunction_OverloadResolution_kAtRuntime: v8_CFunction_OverloadResolution = 1;
pub const v8_CFunction_OverloadResolution_kAtCompileTime: v8_CFunction_OverloadResolution = 2;
...
const _: () = {
    ...
    ["Alignment of v8_CFunction"][::std::mem::align_of::<v8_CFunction>() - 8usize];
...
impl v8_GCCallbackFlags {
    ...
    pub const kGCCallbackFlagSynchronousPhantomCallbackProcessing: v8_GCCallbackFlags =
        v8_GCCallbackFlags(8);
    pub const kGCCallbackFlagCollectAllAvailableGarbage: v8_GCCallbackFlags =
        v8_GCCallbackFlags(16);
    pub const kGCCallbackFlagCollectAllExternalMemory: v8_GCCallbackFlags = v8_GCCallbackFlags(32);
    pub const kGCCallbackScheduleIdleGarbageCollection: v8_GCCallbackFlags = v8_GCCallbackFlags(64);
    pub const kGCCallbackFlagLastResort: v8_GCCallbackFlags = v8_GCCallbackFlags(128);
}
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of v8_HeapStatistics"][::std::mem::size_of::<v8_HeapStatistics>() - 120usize];
    ["Alignment of v8_HeapStatistics"][::std::mem::align_of::<v8_HeapStatistics>() - 8usize];
    ["Offset of field: v8_HeapStatistics::total_heap_size_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_heap_size_) - 0usize];
    ["Offset of field: v8_HeapStatistics::total_heap_size_executable_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_heap_size_executable_) - 8usize];
    ["Offset of field: v8_HeapStatistics::total_physical_size_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_physical_size_) - 16usize];
    ["Offset of field: v8_HeapStatistics::total_available_size_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_available_size_) - 24usize];
    ...
    ["Offset of field: v8_HeapStatistics::peak_malloced_memory_"]
        [::std::mem::offset_of!(v8_HeapStatistics, peak_malloced_memory_) - 64usize];
    ["Offset of field: v8_HeapStatistics::does_zap_garbage_"]
        [::std::mem::offset_of!(v8_HeapStatistics, does_zap_garbage_) - 72usize];
    ["Offset of field: v8_HeapStatistics::number_of_native_contexts_"]
        [::std::mem::offset_of!(v8_HeapStatistics, number_of_native_contexts_) - 80usize];
    ["Offset of field: v8_HeapStatistics::number_of_detached_contexts_"]
        [::std::mem::offset_of!(v8_HeapStatistics, number_of_detached_contexts_) - 88usize];
    ["Offset of field: v8_HeapStatistics::total_global_handles_size_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_global_handles_size_) - 96usize];
    ["Offset of field: v8_HeapStatistics::used_global_handles_size_"]
        [::std::mem::offset_of!(v8_HeapStatistics, used_global_handles_size_) - 104usize];
    ["Offset of field: v8_HeapStatistics::total_allocated_bytes_"]
        [::std::mem::offset_of!(v8_HeapStatistics, total_allocated_bytes_) - 112usize];
};
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of v8_HeapSpaceStatistics"][::std::mem::size_of::<v8_HeapSpaceStatistics>() - 40usize];
    ...
    ["Offset of field: v8_HeapSpaceStatistics::space_used_size_"]
        [::std::mem::offset_of!(v8_HeapSpaceStatistics, space_used_size_) - 16usize];
    ["Offset of field: v8_HeapSpaceStatistics::space_available_size_"]
        [::std::mem::offset_of!(v8_HeapSpaceStatistics, space_available_size_) - 24usize];
    ["Offset of field: v8_HeapSpaceStatistics::physical_space_size_"]
        [::std::mem::offset_of!(v8_HeapSpaceStatistics, physical_space_size_) - 32usize];
};
unsafe extern "C" {
    #[link_name = "\u{1}_ZN2v819HeapSpaceStatisticsC1Ev"]
    pub fn v8_HeapSpaceStatistics_HeapSpaceStatistics(this: *mut v8_HeapSpaceStatistics);
}
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of v8_HeapCodeStatistics"][::std::mem::size_of::<v8_HeapCodeStatistics>() - 32usize];
    ["Alignment of v8_HeapCodeStatistics"]
        [::std::mem::align_of::<v8_HeapCodeStatistics>() - 8usize];
    ["Offset of field: v8_HeapCodeStatistics::code_and_metadata_size_"]
        [::std::mem::offset_of!(v8_HeapCodeStatistics, code_and_metadata_size_) - 0usize];
    ["Offset of field: v8_HeapCodeStatistics::bytecode_and_metadata_size_"]
        [::std::mem::offset_of!(v8_HeapCodeStatistics, bytecode_and_metadata_size_) - 8usize];
    ["Offset of field: v8_HeapCodeStatistics::external_script_source_size_"]
        [::std::mem::offset_of!(v8_HeapCodeStatistics, external_script_source_size_) - 16usize];
    ["Offset of field: v8_HeapCodeStatistics::cpu_profiler_metadata_size_"]
        [::std::mem::offset_of!(v8_HeapCodeStatistics, cpu_profiler_metadata_size_) - 24usize];
};
unsafe extern "C" {
    #[link_name = "\u{1}_ZN2v818HeapCodeStatisticsC1Ev"]
    pub fn v8_HeapCodeStatistics_HeapCodeStatistics(this: *mut v8_HeapCodeStatistics);
}
...
const _: () = {
    ...
    ["Alignment of memory_span_t"][::std::mem::align_of::<memory_span_t>() - 8usize];
    ["Offset of field: memory_span_t::data"][::std::mem::offset_of!(memory_span_t, data) - 0usize];
    ["Offset of field: memory_span_t::size"][::std::mem::offset_of!(memory_span_t, size) - 8usize];
};
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of const_memory_span_t"][::std::mem::size_of::<const_memory_span_t>() - 16usize];
    ["Alignment of const_memory_span_t"][::std::mem::align_of::<const_memory_span_t>() - 8usize];
...
const _: () = {
    ...
    ["Offset of field: ExternalConstOneByteStringResource::_length"]
        [::std::mem::offset_of!(ExternalConstOneByteStringResource, _length) - 16usize];
};
#[repr(C)]
#[derive(Debug)]
...
const _: () = {
    ...
    ["Offset of field: ExternalOneByteStringResource::cached_data_"]
        [::std::mem::offset_of!(ExternalOneByteStringResource, cached_data_) - 8usize];
};
unsafe extern "C" {
...
pub struct ExternalStringResourceBase_SharedMemoryUsageRecorder {
    pub vtable_: *const ExternalStringResourceBase_SharedMemoryUsageRecorder__bindgen_vtable,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ExternalStringResourceBase_SharedMemoryUsageRecorder"]
        [::std::mem::size_of::<ExternalStringResourceBase_SharedMemoryUsageRecorder>() - 8usize];
    ["Alignment of ExternalStringResourceBase_SharedMemoryUsageRecorder"]
        [::std::mem::align_of::<ExternalStringResourceBase_SharedMemoryUsageRecorder>() - 8usize];
};
unsafe extern "C" {
...
pub const v8_String_WriteFlags_kNone: WriteFlags__bindgen_ty_1 = 0;
pub const v8_String_WriteFlags_kNullTerminate: WriteFlags__bindgen_ty_1 = 1;
pub const v8_String_WriteFlags_kReplaceInvalidUtf8: WriteFlags__bindgen_ty_1 = 2;
pub type WriteFlags__bindgen_ty_1 = ::std::os::raw::c_uint;
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
